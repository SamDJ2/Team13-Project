...
@Component({
  selector: 'jhi-social-start',
  templateUrl: './social-start.component.html',
  styleUrls: ['./social-start.component.scss'],
})
export class SocialStartComponent implements OnInit {
  constructor(
  ...
  checkTimers(): void {
    ...
    const timerIds = ['SM1', 'SM2', 'SM3', 'SM4'];
