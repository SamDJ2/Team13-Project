...
@Component({
  selector: 'jhi-smoking-start',
  templateUrl: './smoking-start.component.html',
  styleUrls: ['./smoking-start.component.scss'],
})
export class SmokingStartComponent implements OnInit {
  constructor(
