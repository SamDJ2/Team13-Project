...
describe('Habit Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'habit', component: HabitComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to habitService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getHabitIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getHabitIdentifier).toHaveBeenCalledWith(entity);
