...
@Component({
  selector: 'jhi-alcohol-start',
  templateUrl: './alcohol-start.component.html',
  styleUrls: ['./alcohol-start.component.scss'],
})
export class AlcoholStartComponent implements OnInit {
  constructor(
