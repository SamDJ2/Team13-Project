...
@Component({
  selector: 'jhi-music-start',
  templateUrl: './music-start.component.html',
  styleUrls: ['./music-start.component.scss'],
})
export class MusicStartComponent implements OnInit {
  constructor(
